...
In your browser, navigate to: [https://github.com/okta/okta-idx-java](https://github.com/okta/okta-idx-java)
...
``` bash
$ git clone https://github.com/YOUR_ACCOUNT/okta-idx-java.git
$ cd okta-idx-java
$ git remote add upstream https://github.com/okta/okta-idx-java.git
$ git checkout master
$ git fetch upstream
...
1. In your browser, navigate to your forked repository: [https://github.com/YOUR_ACCOUNT/okta-idx-java](https://github.com/YOUR_ACCOUNT/okta-idx-java)
