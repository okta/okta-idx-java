...
Refer [https://developer.okta.com/docs/reference/api/authn/#get-the-signed-assertion-from-the-webauthn-authenticator1](here) for information on how to extract the assertion data from browser.
